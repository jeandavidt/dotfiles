...
--
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd /Users/jeandavidt/Documents/Obsidian Vault<cr>")
--
-- convert note to template and remove leading white space
vim.keymap.set("n", "<leader>ont", ":ObsidianTemplate Thoughts<cr> :lua vim.cmd([[1,/^\\S/s/^\\n\\{1,}//]])<cr>")
vim.keymap.set("n", "<leader>ond", ":ObsidianTemplate Daily<cr> :lua vim.cmd([[1,/^\\S/s/^\\n\\{1,}//]])<cr>")
...
vim.keymap.set(
	"n",
	"<leader>os",
	':Telescope find_files search_dirs={"/Users/jeandavidt/Documents/Obsidian Vault"}<cr>'
)
vim.keymap.set("n", "<leader>oz", ':Telescope live_grep search_dirs={"/Users/jeandavidt/Documents/Obsidian Vault"}<cr>')
--
